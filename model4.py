...
def CNN_model():
    m = Sequential()
    m.add(Conv1D(1024, 37, padding='same', activation='relu', input_shape=(dataset4.sequence_len, dataset4.amino_acid_residues)))
    ...
    m.add(Conv1D(dataset4.num_classes, 37, padding='same', activation='softmax'))
